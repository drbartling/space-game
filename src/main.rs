...
use bevy::{
    math::Vec3Swizzles, prelude::*, render::camera::ScalingMode,
    tasks::IoTaskPool,
};
...
fn main() {
        ...
        .with_rollback_schedule(
            Schedule::default().with_stage(
                ...
                SystemStage::single_threaded()
                    ...
                    .with_system_set(
                        SystemSet::on_update(GameState::Interlude)
                            .with_system(interlude_timer),
                    )
                    .with_system_set(
    ...
    app.add_state(GameState::AssetLoading)
        ...
        .add_system_set(
            SystemSet::on_update(GameState::InGame).with_system(camera_follow),
        )
        .run();
}
...
fn interlude_timer(
    mut timer: ResMut<InterludeTimer>,
...
fn fire_bullets(
    ...
    for (transform, player, mut bullet_ready, move_dir) in
